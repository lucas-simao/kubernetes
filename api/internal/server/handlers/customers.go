...
func GetCustomers(cs customers.Service) echo.HandlerFunc {
	return func(c echo.Context) error {
		ctx := c.Request().Context()

		customer, err := cs.GetCustomers(ctx)
		if err != nil {
...
func PatchCustomerById(cs customers.Service) echo.HandlerFunc {
	return func(c echo.Context) error {
		ctx := c.Request().Context()
		...
		customerUpdated, err := cs.PatchCustomerById(ctx, p)
		if err != nil {
